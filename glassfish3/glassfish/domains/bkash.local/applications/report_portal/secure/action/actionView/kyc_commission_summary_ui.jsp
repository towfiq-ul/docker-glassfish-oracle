<%-- 
    Document   : kyc_commission_summary_ui
    Created on : Jul 30, 2013, 9:50:54 AM
    Author     : Hafizur_b0266
--%>

<%@ page language="java" %>
<%@ taglib prefix="s" uri="/struts-tags" %>
<% String pagename = "Summary KYC Commission Report ";%>
...
<center>
    ...
    <fieldset class="gradient">
        ...
        <legend style="padding: 4px ;"><h5>SELECT A MONTH TO GENERATE KYC COMMISSION REPORT</h5></legend><br/><br/>
        <s:form action="/secure/action/kycCommissionSummaryResult" onsubmit="return checkdate('datepicker17','datepicker18')">
    ...
    <fieldset class="gradient">
        ...
        <legend style="padding: 4px ;"><h5>SELECT A koi DATE RANGE (FORMAT - MM/DD/YYYY) TO GENERATE KYC STATUS REPORT</h5></legend><br/><br/>
        <s:form action="/secure/action/kycCommissionSummaryReportResult" onsubmit="return checkdate('datepicker17','datepicker18')">

            Start Date : <s:textfield name="datePickerBean.startdate" id="datepicker17" placeholder="Select date" readonly="true"/>
           &nbsp; &nbsp; End Date   : <s:textfield name="datePickerBean.enddate" id="datepicker18" placeholder="Select Month"readonly="true"/><br/><br/>
            <s:submit  style="background: #413F3F repeat;color:#E0E0E0;width: 50px;border: none;margin: 6px;padding: 3;" value="Go" />

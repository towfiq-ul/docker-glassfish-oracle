...
<% String pagename = "Specific Agent Transaction Report";%>
...
<center>
    ...
    <fieldset class="gradient">
        ...
        <legend></legend>
        <b >Agent Wallet No. : <s:property value="datePickerBean.wallet_no"/>&nbsp;&nbsp; Shop Name : <s:property value="commonModelBean.shopName"/>&nbsp;&nbsp;&nbsp;Month : <s:property value="datePickerBean.dp_month"/> </b><br/>

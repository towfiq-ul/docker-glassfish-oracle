...
<center>
    ...
    <fieldset class="gradient">
        ...
        <legend style="padding: 4px ;"><h5>Agent List</h5></legend><br/>
        <s:form action="/secure/action/kycTrackingRep17Result" onsubmit="return checkdate('datepicker_kyc_tr_startdate','datepicker_kyc_tr_enddate')">
            <s:hidden name="target" value="DISTRIBUTOR" />

            <!--Date :--> 
            <%--<s:textfield name="from_date" id="datepicker_kyc_tr_startdate" placeholder="Select date" readonly="true"/>--%>


            <s:submit  style="background: #413F3F repeat;color:#E0E0E0;width: 125px;border: none;margin: 6px;padding: 3;" value="Show Agent List" />

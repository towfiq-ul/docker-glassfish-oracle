<%-- 
    Document   : kyc_comm_summary_ui
    Created on : Jul 24, 2013, 3:49:46 PM
...
<center>
    ...
    <fieldset class="gradient">
        ...
        <s:form action="/secure/action/kycCommissionReportResult" onsubmit="return checkdate('datepicker17','datepicker18')">

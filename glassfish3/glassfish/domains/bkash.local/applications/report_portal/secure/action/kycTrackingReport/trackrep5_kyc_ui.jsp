...
<% String pagename = "Kyc Lifecycle Report";%>
...
<center>
    ...
    <fieldset class="gradient">
        ...
        <legend style="padding: 4px ;"><h5>Kyc Lifecycle Report</h5></legend><br/>
        <s:form action="/secure/action/kycTrackingRep5Result" onsubmit="return checkdate('datepicker_kyc_tr_startdate','datepicker_kyc_tr_enddate')">
    ...
    <fieldset class="gradient">
        ...
        <legend style="padding: 4px ;"><h5>Kyc Lifecycle Report : Date wise (Specific Distributor)</h5></legend><br/>
        <s:form action="/secure/action/kycTrackingRep5Result" onsubmit="return checkdate('datepicker_kyc_tr_startdate_1','datepicker_kyc_tr_enddate_1') && checkwalletno('distwallet1')">
    ...
    <fieldset class="gradient">
        ...
        <legend style="padding: 4px ;"><h5>Kyc Lifecycle Report : Date wise (Specific Distributor & Specific BSA)</h5></legend><br/>
        <s:form action="/secure/action/kycTrackingRep5Result" onsubmit="return checkdate('datepicker_kyc_tr_startdate_2','datepicker_kyc_tr_enddate_2') && checkwalletno('distwallet2') && checkwalletno('distwallet3')">

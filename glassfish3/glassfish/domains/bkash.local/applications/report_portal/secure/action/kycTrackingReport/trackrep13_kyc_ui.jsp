...
<center>
    ...
    <fieldset class="gradient">
        ...
        <legend style="padding: 4px ;"><h5>Daily Registration & Transaction Report: Agent wise</h5></legend><br/>
        <s:form action="/secure/action/kycTrackingRep13Result" onsubmit="return checkdate('datepicker_kyc_tr_startdate','datepicker_kyc_tr_enddate')">

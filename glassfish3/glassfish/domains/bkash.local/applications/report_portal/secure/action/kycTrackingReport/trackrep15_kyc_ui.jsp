...
<center>
    ...
    <fieldset class="gradient">
        ...
        <legend style="padding: 4px ;"><h5>Distributor Detailed Report :Customer Account wise</h5></legend><br/>
        <s:form action="/secure/action/kycTrackingRep15Result" onsubmit="return checkdate15('datepicker_kyc_tr_startdate15','datepicker_kyc_tr_enddate15')">
            <s:hidden name="target" value="DISTRIBUTOR" />

            Start Date : <s:textfield name="from_date" id="datepicker_kyc_tr_startdate15" placeholder="Select date" readonly="true"/>
            &nbsp;  End Date : <s:textfield name="to_date" id="datepicker_kyc_tr_enddate15" placeholder="Select date" readonly="true"/>

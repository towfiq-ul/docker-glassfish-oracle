...
<center>
    ...
    <%    if (request.isUserInRole("COMPLIANCE") || request.isUserInRole("DISTRIBUTOR")) {%>

    <fieldset class="gradient">

        <legend style="padding: 4px ;"><h5>Registration and Balance Report: Agent Wise</h5></legend><br/>
        <s:form action="/secure/action/kycTrackingRep6Result" onsubmit="return checkdate('datepicker_kyc_tr_startdate')">
    ...
    <%    if (request.isUserInRole("SND222")) {%>

    

    <fieldset class="gradient">

        <legend style="padding: 4px ;"><h5>Registration and Balance Report : Date wise (Specific Distributor)</h5></legend><br/>
        <s:form action="/secure/action/kycTrackingRep6Result" onsubmit="return checkdate('datepicker_kyc_tr_startdate_1','datepicker_kyc_tr_enddate_1') && checkwalletno('distwallet1')">
    ...
    <fieldset class="gradient">
        ...
        <legend style="padding: 4px ;"><h5>Registration and Balance Report : Date wise (Specific Distributor & Specific BSA)</h5></legend><br/>
        <s:form action="/secure/action/kycTrackingRep6Result" onsubmit="return checkdate('datepicker_kyc_tr_startdate_2','datepicker_kyc_tr_enddate_2') && checkwalletno('distwallet2') && checkwalletno('distwallet3')">

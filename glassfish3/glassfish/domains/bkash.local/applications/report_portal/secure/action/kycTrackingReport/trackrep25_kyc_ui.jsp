...
<center>
    ...
    <fieldset class="gradient">
        ...
        <legend style="padding: 4px ;"><h5>Lifting Report</h5></legend><br/>
        <% }%>
        ...
        <legend style="padding: 4px ;"><h5>Lifting Report</h5></legend><br/>
        <% }%>
        <s:form action="/secure/action/kycTrackingRep25Result" onsubmit="return checkdate('datepicker_kyc_tr_startdate25','datepicker_kyc_tr_enddate25')">

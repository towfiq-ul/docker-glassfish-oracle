...
<center>
    <fieldset >
        ...
        <div style="overflow:auto; height:380px; width:999px">
            ...
            <table  border ="1" id="tblData" >
                ...
                <th style="padding-left: 10px;padding-right: 10px;">E-Kyc Registration</th>
                </thead>
                <tbody>
                    <tr >
                        ...
                        <s:iterator value="cm_list" id="cm_list" >  
                            ...
                            <td style="padding-left: 10px;padding-right: 10px;text-align: center"><p><s:property value="tr14_ekyc_reg"/></p></td>
    ...
    <br/>
    <s:form action="/secure/action/exportkycTrackingRep14Result">

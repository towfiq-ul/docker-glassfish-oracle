...
<% String pagename = "Summary Report : BSA AGENT WISE";%>
...
<center>
    ...
    <fieldset class="gradient">
        ...
        <legend style="padding: 4px ;"><h5>Summary Report : Date wise</h5></legend><br/>
        <s:form action="/secure/action/kycTrackingRep3Result" onsubmit="return checkdate('datepicker_kyc_tr_startdate','datepicker_kyc_tr_enddate')">
    ...
    <fieldset class="gradient">
        ...
        <s:form action="/secure/action/kycTrackingRep3Result" onsubmit="return checkdate('datepicker_kyc_tr_startdate_1','datepicker_kyc_tr_enddate_1') && checkwalletno('distwallet1')">
    ...
    <fieldset class="gradient">
        ...
        <s:form action="/secure/action/kycTrackingRep3Result" onsubmit="return checkdate('datepicker_kyc_tr_startdate_2','datepicker_kyc_tr_enddate_2') && checkwalletno('distwallet2') && checkwalletno('distwallet3')">

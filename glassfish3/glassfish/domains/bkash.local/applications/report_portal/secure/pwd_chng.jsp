            ...
            <div id="content">
                ...
                <div class="box">
                    ...
                    <div class="box-content">
                        ...
                        <div class="register">
                            <form id="registerForm" name="registerForm" action="<%=request.getContextPath() %>/services/auth/change" method="post">
                                <fieldset>
                                    <legend>Change Password - *Password must be between 8 to 12 character's and have one upper case letter, one lower case letter, one special character (@ or # or $ or %) and one digit</legend>
                                    <table>
                                        <div>
                                            <tr> <th> <label for="email">Email: </label> </th><td>
                                                    <%out.print(request.getUserPrincipal().getName());%><input type="hidden" id="email" name="email" value="<%out.print(request.getUserPrincipal().getName());%>"/></td></tr>
                                        </div>

                                        <div>
                                            <tr> <th> <label for="password1">Password: </label> </th><td>
                                                    <input type="password" id="password1" name="password1"/></td></tr>

                                        </div>


                                        <div>
                                            <tr> <th> <label for="password2">Confirm Password: </label> </th><td>
                                                    <input type="password" id="password2" name="password2"/></td></tr>

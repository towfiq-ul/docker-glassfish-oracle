...
-->
        <panel id="gNavButtonsPanel" name="gNavButtonsPanel" background="${btnpanel_bgcolor}" constraints="BorderLayout.CENTER" insets="0,0,0,0" Layout="GridBagLayout">
          ...
          <smoothbutton border="LineBorder(BLACK)" id="gBtnCancel" name="gBtnCancel" Font="${button_font}" text="${btnCancel_text}" ActionCommand="AC_CANCEL">
          ...
          <smoothbutton border="LineBorder(BLACK)" id="gBtnHelp" name="gBtnHelp" Font="${button_font}" text="${btnHelp_text}" visible="false" ActionCommand="AC_HELP">
          ...
          <panel name="theButtonsExpandablePanel" background="WHITE">
            ...
            <smoothbutton border="LineBorder(BLACK)" id="gBtnBack" name="gBtnBack" Font="${button_font}" text="${btnBack_text}" ActionCommand="AC_BACK">
          ...
          <#if showNext>
            <smoothbutton border="LineBorder(BLACK)" id="gBtnNext" name="gBtnNext" Font="${button_font}" text="${btnNext_text}" ActionCommand="AC_NEXT">
          ...
          <#else>
            <smoothbutton border="LineBorder(BLACK)" id="gBtnExit" name="gBtnExit" Font="${button_font}" text="${btnExit_text}" ActionCommand="AC_EXIT">
              <gridbagconstraints gridx="4" gridy="0" ${btnNext_constraints} gridwidth="1" gridheight="1" weightx="0" weighty="0" fill="GridBagConstraints.NONE" anchor="GridBagConstraints.EAST"/>
            </smoothbutton>
          </#if>

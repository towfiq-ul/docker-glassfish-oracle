...
<frame id="gFrame" Size="${frame_size}" MinimumSize="${frame_size}" Title="${PRODUCT_NAME}" Layout="BorderLayout" Resizable="true" DefaultCloseOperation="JFrame.EXIT_ON_CLOSE">

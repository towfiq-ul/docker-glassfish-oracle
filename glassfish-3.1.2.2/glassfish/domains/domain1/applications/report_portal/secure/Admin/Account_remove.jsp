            ...
            <div id="content">
                ...
                <div class="box">
                    ...
                    <div class="box-content">
                        ...
                        <div class="register">
                            <form id="registerForm" name="registerForm" action="<%=request.getContextPath()%>/services/auth/remove" method="post">
                                <fieldset>
                                    ...
                                    <table>
                                        ...
                                        <div class="buttonRow">
                                            <tr><td><input type="submit" style="background: #413F3F repeat;color:#E0E0E0;height:25px;width: 80px;border: none;margin: 6px;padding: 3;" value="Remove" /></td></tr>
                                        </div>
                                    </table> 
                                </fieldset>
                            </form> 

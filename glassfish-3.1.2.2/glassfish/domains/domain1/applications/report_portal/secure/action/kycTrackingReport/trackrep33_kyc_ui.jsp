...
<% String pagename = "Distributor Performance Summary";%>
...
<center>
    ...
    <fieldset class="gradient">
        <s:form action="/secure/action/kycTrackingRep33Result" onsubmit="return checkDistributorAndMTDAndDate('checkbox-MTD','datepicker_kyc_tr_startdate27','datepicker_kyc_tr_enddate27')">

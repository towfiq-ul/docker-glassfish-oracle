...
<center>
    ...
    <%    if (request.isUserInRole("DISTRIBUTOR") || request.isUserInRole("SalesOps")) {%>

    <fieldset class="gradient">

        <legend style="padding: 4px ;"><h5>Distributor Wise Report</h5></legend><br/>
        <s:form action="/secure/action/kycTrackingRep12Result" onsubmit="return checkdate('datepicker_kyc_tr_startdate','datepicker_kyc_tr_enddate')">

...
<% String pagename = "Monthly BSA Transaction Report";%>
...
<center>
    ...
    <fieldset class="gradient">
        ...
        <legend></legend>
        <b >BSA Channel : <s:property value="commonModelBean.ct_RA_CHANNEL"/>&nbsp; &nbsp;BSA Wallet No. : <s:property value="datePickerBean.wallet_no"/>&nbsp; &nbsp;Month : <s:property value="datePickerBean.dp_month"/>  </b><br/>

...
String reportFileName = "exportkycTrackingRep22Result";
...
<center>
    <fieldset >
        <legend  style="font-size: 1em;color: #052b4d; font: Arial, sans-serif;"><b>
                MA Wallet: <s:property value="ma_wallet"/>&nbsp;;Date Range: <s:property value="from_date"/> - <s:property value="to_date"/> 
            </b></legend>
            ...
            <table  border ="1" id="tblData" >
                ...
                <s:iterator value="cm_list" id="cm_list" >
                    <tr>
                        ...
                        <td style="padding-left: 10px;padding-right: 10px;text-align: center"><p><s:property value="tr22_ekyc_registration_count"/></p></td>

...
<center>
    ...
    <fieldset class="gradient">
        ...
        <legend style="padding: 4px ;"><h5>Transaction Summary Report : DSO wise</h5></legend><br/>
        <s:form action="/secure/action/kycTrackingRep18Result" onsubmit="return checkdate('datepicker_kyc_tr_startdate','datepicker_kyc_tr_enddate')">
            ...
            <%--<s:textfield name="to_date" id="datepicker_kyc_tr_enddate" placeholder="Select date" readonly="true"/>--%>
    ...
    <fieldset class="gradient">
        ...
        <s:form action="/secure/action/kycTrackingRep18Result" onsubmit="return checkdate('datepicker_kyc_tr_startdate_1','datepicker_kyc_tr_enddate_1') && checkwalletno('distwallet1')">
    ...
    <fieldset class="gradient">
        ...
        <legend style="padding: 4px ;"><h5>Registration Summary Report: Agent wise</h5></legend><br/>
        <s:form action="/secure/action/kycTrackingRep18Result" onsubmit="return checkdate('datepicker_kyc_tr_startdate_2','datepicker_kyc_tr_enddate_2') && checkwalletno('distwallet2') && checkwalletno('distwallet3')">

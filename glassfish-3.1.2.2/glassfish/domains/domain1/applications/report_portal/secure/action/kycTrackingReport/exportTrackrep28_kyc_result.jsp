<%-- 
    Document   : exportTrackrep28_kyc_result
    Created on : Dec 23, 2018, 1:59:19 PM
...
<% String pagename = "Agent_Wise_Check_IN_and_B2B_report";

    SimpleDateFormat ft = new SimpleDateFormat("dd-MM-yy hh:mm a");
    String reportFileName = "Agent_Wise_Check_IN_and_B2B_report" + ft.format(new Date());

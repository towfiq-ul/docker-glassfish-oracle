...
<% String pagename = "Transaction Summary Report : Date wise";%>
...
<center>
    ...
    <fieldset class="gradient">
        ...
        <legend style="padding: 4px ;"><h5>Transaction Summary Report : Date wise</h5></legend><br/>
        <s:form action="/secure/action/kycTrackingRep16Result" onsubmit="return checkdate('datepicker_kyc_tr_startdate','datepicker_kyc_tr_enddate')">

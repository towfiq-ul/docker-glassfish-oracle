...
<% String pagename = "Daily Performance Report : DSO wise";%>
...
<center>
    ...
    <fieldset class="gradient">
        ...
        <legend style="padding: 4px ;"><h5>Daily Performance Report : DSO wise</h5></legend><br/>
        <s:form action="/secure/action/kycTrackingRep20Result" onsubmit="return checkdate('datepicker_kyc_tr_startdate','datepicker_kyc_tr_enddate')">
            <s:hidden name="target" value="DISTRIBUTOR" />
            <label>Select DSO: </label> <s:select list="dsoWallets" listKey="walletNo" listValue="walletNo" name="selectDSOWallet" label="Status" />
            Or Input DSO: <s:textfield name="input_dso" />
    ...
    <fieldset class="gradient">
        ...
        <legend style="padding: 4px ;"><h5>Registration Summary Report: DSO wise</h5></legend><br/>
        <s:form action="/secure/action/kycTrackingRep11Result" onsubmit="return checkdate('datepicker_kyc_tr_startdate','datepicker_kyc_tr_enddate')">
    ...
    <fieldset class="gradient">
        ...
        <s:form action="/secure/action/kycTrackingRep11Result" onsubmit="return checkdate('datepicker_kyc_tr_startdate_1','datepicker_kyc_tr_enddate_1') && checkwalletno('distwallet1')">
    ...
    <fieldset class="gradient">
        ...
        <legend style="padding: 4px ;"><h5>Registration Summary Report: Agent wise</h5></legend><br/>
        <s:form action="/secure/action/kycTrackingRep11Result" onsubmit="return checkdate('datepicker_kyc_tr_startdate_2','datepicker_kyc_tr_enddate_2') && checkwalletno('distwallet2') && checkwalletno('distwallet3')">

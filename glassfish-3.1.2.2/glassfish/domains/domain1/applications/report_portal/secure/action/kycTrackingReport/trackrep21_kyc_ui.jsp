...
<%    if ((request.isUserInRole("RSM")) ){%>
        <legend style="padding: 4px ;"><h5>Registration Summary Report : Distributor wise</h5></legend><br/>
        <% } %>
        ...
        <legend style="padding: 4px ;"><h5>Registration Summary Report : Distributor wise</h5></legend><br/>
        <% } %>
        <s:form action="/secure/action/kycTrackingRep21Result" onsubmit="return checkdate('datepicker_kyc_tr_startdate','datepicker_kyc_tr_enddate')">
